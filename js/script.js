$(document).ready(function(){
  if ($( window ).width() > 1273)
    alert("Thanks for visiting my website! Just a tip that it is best viewed at ~1273px or lower. This is because my video and carousel pictures are not bigger than this width");
